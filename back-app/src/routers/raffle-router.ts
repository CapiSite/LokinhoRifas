...
import {activeRaffle, createRaffle, deleteRaffle, getAllRaffles, getRaffles, buyRaffleController, addParticipantToRaffle, removeParticipantFromRaffle, reserveRaffleNumberController,
...
raffleRouter.post( '/reserveRaffleNumbers', authenticateToken, validateBody(buyRaffleSchema), reserveRaffleNumberController);
